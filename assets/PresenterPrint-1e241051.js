import{d as m,i as _,a as p,u as h,b as u,c as d,e as f,f as n,g as t,t as s,h as a,F as v,r as g,n as x,j as y,o as r,k as b,l as k,m as N,p as w,q as P,_ as S}from"./index-091e09d0.js";import{N as V}from"./NoteDisplay-73ed8301.js";const j={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},z=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=m({__name:"PresenterPrint",setup(q){_(p),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
